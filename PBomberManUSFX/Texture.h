...
public:
	...
	bool loadFromImage(std::string path, Uint8 r = 0, Uint8 g = 0, Uint8 b = 0);	//creamos una textura a partir de una imagen para poder usarla luego
...
};				//creamos un rectángulo a partir de los parámentros, para luego mostrar la imagen del anterior método
